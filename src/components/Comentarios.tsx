      ...
      <div className="container mx-auto px-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-2/3 relative py-8 order-1 lg:order-1 overflow-hidden">
            <div className="overflow-visible px-8"> {/* More padding for shadows */}
              <div 
              ...
              >
                {testimonials.map((item, i) => (
                  <div 
                    key={i} 
                    className="w-[calc(40%-20px)] flex-shrink-0 bg-white p-8 rounded-[32px] shadow-[0_15px_45px_rgba(0,0,0,0.06)] hover:shadow-[0_25px_65px_rgba(0,0,0,0.1)] transition-all duration-500 flex flex-col justify-between min-h-[350px] relative z-10"
                  >
